...
#### Domain-Specific RDP Attack against CIDR, scanning first for RDP then trying our list with mellonaut
user="mellonaut"
domain=$fqdn
cidr="$cidr"
wordlist=".\knownpasswords.txt"
...
#### Discovery Mode Domain-Specific RDP Attack against CIDR, scanning first for RDP then trying userlist with password list
cidr="$cidr"
userlist="users.txt"
wordlist=".\knownpasswords.txt"
...
## Phase 2a. Over and Over, until it's done
...
## Phase 3a. Lateral Spread and Domain Escalation
